...
public:
     ...
     * @param ds
     */
    Car(BluetoothModule& bt, Engine& right_en, Engine& left_en, DistanceSensor& ds_front, DistanceSensor& ds_side, MPU6050& mpu): bt_(bt), right_en_(right_en), left_en_(left_en), ds_front_(ds_front), ds_side_(ds_side), speed_(0), mode_('n'), state_(4), mpu_(mpu) {}
...
private:
    ...
    DistanceSensor& ds_side_;
    MPU6050& mpu_;
    int distance_buffer[4];
    int speed_;
    char mode_;
    int state_;
    char automatic_mode;
